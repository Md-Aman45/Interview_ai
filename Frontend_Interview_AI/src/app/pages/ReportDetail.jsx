        ...
        >
          {q.intention && (
            ...
            >
              ...
              >
                <strong style={{ color: "var(--foreground)" }}>Tests: </strong>
                {q.intention}
              </div>
            </div>
          )}
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          {gap.suggestion || gap.recommendation}
        </p>
      </div>
    </div>
  );
...
export function ReportDetail() {
  ...
  const badge = getRecommendationBadge(
    report.hiringRecommendation?.decision ?? report.hiringRecommendation,
  );
  const radarData = [
    ...
    <Layout
      ...
      actions={
        <button
          ...
          disabled={downloading || resumeLimitReached}
          ...
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6">
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "var(--muted-foreground)" }}>
                  Confidence{" "}
                  {Math.round(report.hiringRecommendation?.confidence || 0)}%
                </div>
              </div>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <ScoreBar
                ...
                value={report.matchScore.problemSolving}
              />
              <ScoreBar
                label="Communication"
                value={report.matchScore.communication}
              />
            </div>
          </div>
            ...
            <div>
              ...
              >
                {report.overallAnalysis ||
                  report.hiringRecommendation?.reasoning ||
                ...
                {tab.count !== undefined && (
                  <span
                    style={{
                      ...
                      borderRadius: 100,
                      background:
                        activeTab === tab.id ? "#6366f1" : "var(--muted)",
                      color:
                        activeTab === tab.id
                          ? "#fff"
                          : "var(--muted-foreground)",
          ...
          {activeTab === "overview" && (
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6">
                ...
                >
                  {(report.skillGaps || []).slice(0, 3).map((g, i) => (
                    <GapCard key={i} gap={g} />
                  ))}
              ...
              <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6">
                ...
                <div
                  style={{ display: "flex", flexDirection: "column", gap: 10 }}
                >
                  {(report.preparationPlan || []).slice(0, 3).map((d, i) => (
                    <DayCard key={i} plan={d} />
                  ))}
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {allQuestions.map((q, i) => (
                <QuestionCard
                  ...
                  index={
                    q._type === "technical"
                      ? report.technicalQuestions.indexOf(q)
                      : report.behavioralQuestions.indexOf(q)
                  }
                  type={q._type}
                />
              ))}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {report.skillGaps?.length ? (
                ...
                <p style={{ fontSize: 13, color: "var(--muted-foreground)" }}>
                  No skill gaps returned for this report.
                </p>
              )}
            </div>
          )}
